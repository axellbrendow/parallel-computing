/*
  Sequencial:
	...
	Parallel for private(current_city) schedule(static):
		compute_path 1:
      tempo1: 0.069810
      tempo2: 0.076564
      tempo3: 0.063623
      media:  0.06999899999999999

    compute_path 2:
      tempo1: 0.396152
      tempo2: 0.548380
      tempo3: 0.403025
      media:  0.44918566666666665

	Parallel for private(current_city) schedule(dynamic,100):
		compute_path 1:
      tempo1: 0.075346
      tempo2: 0.049211
      tempo3: 0.060271
      media:  0.06160933333333333

    compute_path 2:
      tempo1: 0.520065
      tempo2: 0.339276
      tempo3: 0.327386
      media:  0.3955756666666667

	Agora as outras duas funções paralelizadas:
    merge_path - sequencial:
			tempo1: 0.000050
			tempo2: 0.000055
			tempo3: 0.000067
			media:  5.7333333333333336e-05

    merge_path - parallel for collapse(2) schedule(dynamic, 100):
			tempo1: 0.000055
			tempo2: 0.000050
			tempo3: 0.000056
			media:  5.366666666666667e-05

    fill_travel - sequencial:
      fill_travel 1:
        tempo1: 0.001477
        tempo2: 0.000646
        tempo3: 0.000487
      ...
      fill_travel 2:
        ...
        tempo2: 0.000729
        tempo3: 0.000730
        media:  0.0014373333333333332

    fill_travel - parallel for schedule(dynamic, 100) com critical dentro:
      fill_travel 1:
        tempo1: 0.001219
        tempo2: 0.000567
        tempo3: 0.000509
        media:  0.0007650000000000001
        
      fill_travel 2:
        tempo1: 0.000400
        tempo2: 0.000433
        tempo3: 0.000399
        media:  0.00041066666666666666
*/
...
Travel work_hard(vector<Flight>& flights, Parameters& parameters, vector<vector<string> >& alliances){
  ...
  printf("\nFirst fill_travel Time = %f", end - start);
  ...
  printf("\nSecond fill_travel Time = %f", end - start);
